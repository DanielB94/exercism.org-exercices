...
def eat_ghost(power_pellet_active, touching_ghost):
    ...
    Notes: It is innecessary evaluate booleans with == True
    """
...
def lose(power_pellet_active, touching_ghost):
    ...
    Returns:
        ...
        NOTES:
        not is the same as ! in JavaScript
    """
...
def win(has_eaten_all_dots, power_pellet_active, touching_ghost):
    ...
    if power_pellet_active and touching_ghost and has_eaten_all_dots:
        return True
    elif power_pellet_active and not touching_ghost and has_eaten_all_dots:
        return False
        ...
        NOTE:
        The code above was my original code which passed test but i asked claude to improve it and gave me the one below, im only using it bcs i understood the logic used by it
        """
