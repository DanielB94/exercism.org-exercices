...
def fix_list_of_wagons(each_wagons_id, missing_wagons):
    ...
    """
    reposition_one, reposition_two, reposition_three, *rest_of_wagons = each_wagons_id
    *new_list, = reposition_three, *missing_wagons, *rest_of_wagons, reposition_one, reposition_two
    return new_list
...
def add_missing_stops(route, **stops):
    ...
    """
    routes = route.copy()
    routes['stops'] = list(stops.values())
    return routes
...
def extend_route_information(route, more_route_information):
    ...
    """
    extended_dict = {**route, **more_route_information}
