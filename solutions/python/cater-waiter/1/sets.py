...
def clean_ingredients(dish_name, dish_ingredients):
    ...
    """
    ingredients_set = set(dish_ingredients) # Al hacer el set automaticamente se eliminan los duplicados
    clean_tuple = dish_name, ingredients_set # Tuple unpacking por eso no hace falta ponerle ()
    return clean_tuple
...
def categorize_dish(dish_name, dish_ingredients):
    ...
    if dish_ingredients_set <= PALEO:
        category = 'PALEO'
    elif dish_ingredients_set <= KETO:
        category = 'KETO'
    elif dish_ingredients_set <= VEGAN:
        category = 'VEGAN'
    elif dish_ingredients_set <= VEGETARIAN:
        category = 'VEGETARIAN'
    else:
        category = "OMNIVORE"
...
def tag_special_ingredients(dish):
    ...
    tag_ingredients = set(dish[1]) & SPECIAL_INGREDIENTS
    dish_final = dish[0], tag_ingredients
    return dish_final
